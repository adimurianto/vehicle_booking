$(document).ready(function(){
  ...
  var save_method = "add";
    ...
    $(document).on('click','.btn-process-data', function(){
      var _ = $(this);
      var id = _.attr('data-id');
      var approve = _.attr('data-approve');

      Swal.fire({
        title: 'Apakah anda yakin?',
        text: "Ingin "+(approve == 'yes' ? "Approve" : "Reject")+" data yang dipilih",  
        type: 'warning',
    ...
    function processData(id,approve){
      $.ajax({
        url: BaseUrl+"Approval/processData/",
        method: "POST",
        data: {
          id: id,
          approve: approve,
    ...
    function deletedData(){
      $.ajax({
        url: BaseUrl+"Approval/deleteData/",
        method: "POST",
    ...
    $('#form').validate({
        ...
        submitHandler: function(e){
          var url;
          if(save_method == "add"){
            url = BaseUrl+"Approval/addData";
          }else{
            url = BaseUrl+"Approval/updateData";
          }
