$(document).ready(function(){
  ...
  var save_method = "add";
    ...
    function deletedData(){
      $.ajax({
        url: BaseUrl+"Drivers/deleteData/",
        method: "POST",
          ...
          success: function(data){
            ...
            if(data != null){
              ...
              if(data.phone.length > 0){
                $('input[name="phone"]').parent().addClass("active"); 
              }
    ...
    $('#form').validate({
        ...
        submitHandler: function(e){
          var url;
          if(save_method == "add"){
            url = BaseUrl+"Drivers/addData";
          }else{
            url = BaseUrl+"Drivers/updateData";
          }
