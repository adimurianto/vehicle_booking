        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if(data != null){
              ...
              $('select[name="level"] option[value="'+data.id_group+'"').prop('selected',true);
              ...
              if(data.email.length > 0){
                $('input[name="email"]').parent().addClass("active");
              }
              if(data.phonenumber.length > 0){
                $('input[name="phonenumber"]').parent().addClass("active");
              }
