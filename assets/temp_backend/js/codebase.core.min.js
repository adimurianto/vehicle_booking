...
!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        (w = ae.setDocument = function (e) {
            ...
            return (
                i !== x &&
                    ...
                    (d.qsa = ee.test(x.querySelectorAll)) &&
                        (ue(function (e) {
                            (a.appendChild(e).innerHTML = "<a id='" + C + "'></a><select id='" + C + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                ...
                                e.querySelectorAll("[selected]").length || m.push("\\[" + W + "*(?:value|" + H + ")"),
                    ...
                    (d.matchesSelector = ee.test((v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector))) &&
                        ue(function (e) {
        ...
        (ae.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== x && w(e), d.matchesSelector && T && !k[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t))))
                try {
                    var n = v.call(e, t);
                        ...
                        : function (e, t, n) {
                              ...
                              if (u) {
                                  ...
                                  if (((l = [y ? u.firstChild : u.lastChild]), y && h)) {
                                      for (
                                          d = (a = (i = (r = (o = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2], s = a && u.childNodes[a];
            ...
            return (
                ...
                ce(function (e, t, n, i) {
                    var r,
                        ...
                        h = g ? (v || (e ? d : c || m) ? [] : t) : f;
                    if ((g && g(f, h, n, i), m)) for (r = we(h, l), m(r, [], n, i), o = r.length; o--; ) (s = r[o]) && (h[l[o]] = !(f[l[o]] = s));
                    if (e) {
                        if (v || d) {
                            if (v) {
        ...
        function Te(e) {
            for (
                var r,
                    ...
                    u = [
                        function (e, t, n) {
                            var i = (!o && (n || t !== E)) || ((r = t).nodeType ? l : c)(e, t, n);
                            return (r = null), i;
                        },
                    ];
                a < i;
                ...
                if ((t = _.relative[e[a].type])) u = [_e(Ee(u), t)];
                    ...
                    if ((t = _.filter[e[a].type].apply(null, e[a].matches))[C]) {
                        ...
                        return xe(1 < a && Ee(u), 1 < a && be(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(U, "$1"), t, a < n && Te(e.slice(a, n)), n < i && Te((e = e.slice(n))), n < i && be(e));
                    }
                    u.push(t);
                }
            return Ee(u);
        ...
        return (
            ...
            (p = ae.tokenize = function (e, t) {
                ...
                for (s = e, a = [], l = _.preFilter; s; ) {
                    ...
                    (n = !1),
                    (i = V.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace(U, " ") }), (s = s.slice(n.length))),
                    _.filter))
    ...
    ((C.fn.init = function (e, t, n) {
        ...
        if (i[1]) {
            if (((t = t instanceof C ? t[0] : t), C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), D.test(i[1]) && C.isPlainObject(t))) for (i in t) b(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this;
        }
                        ...
                        a &&
                            ...
                            (function n(e) {
                                C.each(e, function (e, t) {
                                    b(t) ? (i.unique && u.has(t)) || a.push(t) : t && t.length && "string" !== E(t) && n(t);
                                });
                            })(arguments),
                            e && !o && r()),
                        this
                                            ...
                                            (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                b(t)
                                                    ? a
                                                        ...
                                                        : (l++, t.call(e, c(l, o, R, a), c(l, o, H, a), c(l, o, R, o.notifyWith)))
    ...
    (C.fn.ready = function (e) {
        ...
        (C.ready.then = F.then),
        "complete" === T.readyState || ("loading" !== T.readyState && !T.documentElement.doScroll) ? x.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", B), x.addEventListener("load", B));
    ...
    function fe(e, t) {
        for (var n, i, r, o, s, a, l = [], c = 0, u = e.length; c < u; c++)
            (i = e[c]).style &&
                ((n = i.style.display),
                t
                    ? ("none" === n && ((l[c] = K.get(i, "display") || null), l[c] || (i.style.display = "")),
                      "" === i.style.display &&
                          ae(i) &&
                          (l[c] =
                              ((a = o = r = void 0),
                              (o = i.ownerDocument),
                              (s = i.nodeName),
                              (a = ue[s]) || ((r = o.body.appendChild(o.createElement(s))), (a = C.css(r, "display")), r.parentNode.removeChild(r), "none" === a && (a = "block"), (ue[s] = a)))))
                    : "none" !== n && ((l[c] = "none"), K.set(i, "display", n)));
    ...
    function Ee(e, t, n, i, r) {
        ...
        for (f.textContent = "", d = 0; (o = h[d++]); )
            ...
            else if (((c = oe(o)), (s = me(f.appendChild(o), "script")), c && ve(s), n)) for (u = 0; (o = s[u++]); ) pe.test(o.type || "") && n.push(o);
        return f;
    }
              ...
              C.event.add(e, r, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[r]) {
                          ...
                          else if (((i = a.call(arguments)), K.set(this, r, i), (t = o(this, r)), this[r](), i !== (n = K.get(this, r)) || t ? K.set(this, r, !1) : (n = {}), i !== n))
                ...
                for (
                    ...
                    (d = g = (a = Te.exec(e[c]) || [])[1]),
                        ...
                        d &&
                            ...
                            (f = C.event.special[d] || {}),
                            (u = C.extend({ type: d, origType: g, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && C.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
    ...
    function Re(e, t) {
        var n, i, r, o, s, a, l, c;
        if (1 === t.nodeType) {
            if (K.hasData(e) && ((o = K.access(e)), (s = K.set(t, o)), (c = o.events))) for (r in (delete s.handle, (s.events = {}), c)) for (n = 0, i = c[r].length; n < i; n++) C.event.add(t, r, c[r][n]);
                ...
                for (c = s[s.length - 1].ownerDocument, C.map(s, Pe), u = 0; u < a; u++)
                    (l = s[u]),
                        pe.test(l.type || "") &&
                            ...
                            C.contains(c, l) &&
                            (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }) : _(l.textContent.replace(Le, ""), l, c));
        }
        return n;
    }
    function We(e, t, n) {
    ...
    C.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (o = o || me(e), s = s || me(u), i = 0, r = o.length; i < r; i++) Re(o[i], s[i]);
                else Re(e, u);
    ...
    function Ke(e, t, n) {
        ...
        return (
            (n = n || Qe(e)) &&
                ...
                !y.pixelBoxStyles() && Ye.test(s) && Xe.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function Ge(e, t) {
    ...
    function Je() {
        if (Ve) {
            ($e.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0"),
                ...
                re.appendChild($e).appendChild(Ve);
    ...
    function ut(e, t, n) {
        ...
        return (
            ((!y.boxSizingReliable() && r) || "auto" === s || (!parseFloat(s) && "inline" === C.css(e, "display", !1, i))) && e.getClientRects().length && ((r = "border-box" === C.css(e, "boxSizing", !1, i)), (o = a in e) && (s = e[a])),
    ...
    C.extend({
        ...
        C.each(["height", "width"], function (e, l) {
            C.cssHooks[l] = {
                get: function (e, t, n) {
                    if (t)
                        return !rt.test(C.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? ut(e, l, n)
                            : le(e, st, function () {
                                  return ut(e, l, n);
                              });
                ...
                set: function (e, t, n) {
                    var i,
                        ...
                        a = n ? ct(e, l, n, s, r) : 0;
                    return (
                        s && o && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(r[l]) - ct(e, l, "border", !1, r) - 0.5)),
    ...
    (C.Animation = C.extend(wt, {
        ...
        C.each({ slideDown: _t("show"), slideUp: _t("hide"), slideToggle: _t("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, i) {
        ...
        C.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s
                    ...
                    : this.each(function () {
                          var e, t, n, i;
                          if (s) for (t = 0, n = C(this), i = Dt(r); (e = i[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
            ...
            hasClass: function (e) {
                var t,
                    n,
                    i = 0;
                for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && -1 < (" " + At(Ot(n)) + " ").indexOf(t)) return !0;
                return !1;
            },
        });
    var kt = /\r/g;
            ...
            if (
                ...
                for (r = 0; (o = h[r++]) && !e.isPropagationStopped(); )
                    (f = o),
                        ...
                        (c = (K.get(o, "events") || {})[e.type] && K.get(o, "handle")) && c.apply(o, t),
    ...
    (Kt.href = Lt.href),
        C.extend({
            ...
            ajax: function (e, t) {
                ...
                var u,
                    ...
                    w = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (p) {
                                if (!n) for (n = {}; (t = Ut.exec(h)); ) n[t[1].toLowerCase() + " "] = (n[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = n[e.toLowerCase() + " "];
                            }
                ...
                if (
                    (b.promise(w),
                    (m.url = ((e || m.url || Lt.href) + "").replace(Vt, Lt.protocol + "//")),
                ...
                (f = m.url.replace(Bt, "")),
                m.hasContent
                    ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Ft, "+"))
                    : ((o = m.url.slice(f.length)),
                      m.data && (m.processData || "string" == typeof m.data) && ((f += (Mt.test(f) ? "&" : "?") + m.data), delete m.data),
                      !1 === m.cache && ((f = f.replace(zt, "$1")), (o = (Mt.test(f) ? "&" : "?") + "_=" + jt++ + o)),
                      (m.url = f + o)),
                m.ifModified && (C.lastModified[f] && w.setRequestHeader("If-Modified-Since", C.lastModified[f]), C.etag[f] && w.setRequestHeader("If-None-Match", C.etag[f])),
                ((m.data && m.hasContent && !1 !== m.contentType) || t.contentType) && w.setRequestHeader("Content-Type", m.contentType),
                w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Xt + "; q=0.01" : "") : m.accepts["*"]),
                m.headers))
                ...
                function c(e, t, n, i) {
                    ...
                    p ||
                        ...
                        r
                            ? (m.ifModified && ((l = w.getResponseHeader("Last-Modified")) && (C.lastModified[f] = l), (l = w.getResponseHeader("etag")) && (C.etag[f] = l)),
        ...
        C.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                return (
                    ...
                    s ? (e[s] = e[s].replace(on, "$1" + i)) : !1 !== e.jsonp && (e.url += (Mt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
        ...
        (C.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (r = D.exec(e)) ? [t.createElement(r[1])] : ((r = Ee([e], t, o)), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
            var i, r, o;
        }),
    ...
    (function (e, t) {
        ...
        p(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', h._handleDismiss(new h())),
        ...
        var m,
            ...
            C = { CLICK_DATA_API: "click" + b + _, FOCUS_BLUR_DATA_API: "focus" + b + _ + " blur" + b + _, LOAD_DATA_API: "load" + b + _ },
            S =
                (((m = A.prototype).toggle = function () {
                    ...
                    if (n) {
                        ...
                        if (i) {
                            ...
                            else ("checkbox" !== i.type || ("LABEL" === this._element.tagName && i.checked === this._element.classList.contains(w))) && (e = !1);
            ...
            B =
                ...
                (O._triggerSlideEvent = function (e, t) {
                    var n = this._getItemIndex(e),
                        ...
                        r = p.Event(H.SLIDE, { relatedTarget: e, direction: t, from: i, to: n });
                ...
                (O._slide = function (e, t) {
                    ...
                    if (((r = e === P ? ((n = "carousel-item-left"), (i = "carousel-item-next"), "left") : ((n = "carousel-item-right"), (i = "carousel-item-prev"), "right")), l && p(l).hasClass(W))) this._isSliding = !1;
                        ...
                        var f = p.Event(H.SLID, { relatedTarget: l, direction: r, from: a, to: c });
        ...
        p(document).on(H.CLICK_DATA_API, "[data-slide], [data-slide-to]", B._dataApiClickHandler),
        ...
        var U,
            ...
            ie =
                ...
                (U.show = function () {
                    ...
                    if (
                        ...
                        if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                            e && (re._jQueryInterface.call(p(e).not(this._selector), "hide"), t || p(e).data(V, null));
                ...
                (U._getConfig = function (e) {
                    return ((e = s({}, X, {}, e)).toggle = Boolean(e.toggle)), g.typeCheckConfig($, e, K), e;
                }),
                ...
                (re._jQueryInterface = function (i) {
                    return this.each(function () {
                        ...
                        if ((!t && n.toggle && /show|hide/.test(i) && (n.toggle = !1), t || ((t = new re(this, n)), e.data(V, t)), "string" == typeof i)) {
        ...
        p(document).on(G.CLICK_DATA_API, ne, function (e) {
            ...
            (p.fn[$] = ie._jQueryInterface),
            (p.fn[$].Constructor = ie),
            (p.fn[$].noConflict = function () {
                return (p.fn[$] = Q), ie._jQueryInterface;
            });
        ...
        function Ne(e, t, i, n, r, o) {
            ...
            var a = ke(i, n, s, r),
                ...
                c = Object.keys(l)
                    .map(function (e) {
                        return Ce({ key: e }, l[e], { area: (t = l[e]).width * t.height });
                        var t;
                    })
                    .sort(function (e, t) {
        ...
        function Qe(e, t) {
            var n = 1 < arguments.length && void 0 !== t && t,
                i = Ye.indexOf(e),
                r = Ye.slice(i + 1).concat(Ye.slice(0, i));
                            ...
                            return (
                                E.forEach(function (e, t) {
                                    ...
                                    (o || u || p) &&
                                        ...
                                        (g.placement = y + (_ ? "-" + _ : "")),
                                        (g.offsets.popper = Ce({}, g.offsets.popper, Me(g.instance.popper, g.offsets.reference, g.placement))),
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var s,
                                ...
                                w = me(e.instance.popper),
                                x = Ae(w),
                                T = { position: r.position },
                                C =
                                    ((l = e),
                                    (c = window.devicePixelRatio < 2 || !Ue),
                                    (u = l.offsets),
                                    (f = u.popper),
                                    (h = u.reference),
                                    (d = Math.round),
                                    ...
                                    (_ = c ? d : D),
                                    { left: (b = c ? (v || y || g % 2 == m % 2 ? d : p) : D)(g % 2 == 1 && m % 2 == 1 && !y && c ? f.left - 1 : f.left), top: _(f.top), bottom: _(f.bottom), right: b(f.right) }),
                            ...
                            if (
                                ((a = "bottom" == S ? ("HTML" === w.nodeName ? -w.clientHeight + C.bottom : -x.height + C.bottom) : C.top),
                                (s = "right" == A ? ("HTML" === w.nodeName ? -w.clientWidth + C.right : -x.width + C.right) : C.left),
                                E && O)
                            )
                                (T[O] = "translate3d(" + s + "px, " + a + "px, 0)"), (T[S] = 0), (T[A] = 0), (T.willChange = "transform");
                            else {
                                var k = "bottom" == S ? -1 : 1,
                                    N = "right" == A ? -1 : 1;
                                (T[S] = a * k), (T[A] = s * N), (T.willChange = S + ", " + A);
                            }
                            var I = { "x-placement": e.placement };
                            return (e.attributes = Ce({}, I, e.attributes)), (e.styles = Ce({}, T, e.styles)), (e.arrowStyles = Ce({}, e.offsets.arrow, e.arrowStyles)), e;
                        },
                        gpuAcceleration: !0,
                        x: "bottom",
                        y: "right",
                            ...
                            return function () {
                                this.state.eventsEnabled ||
                                    (this.state = (function (e, t, n) {
                                        (t.updateBound = n), qe(e).addEventListener("resize", t.updateBound, { passive: !0 });
                                        var i = fe(e);
                                        return (
                                            (function e(t, n, i, r) {
        ...
        function et(e, t) {
            ...
            !(function (e) {
                ...
                (this.options = Ce({}, et.Defaults, i)),
                (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
                (this.reference = e && e.jquery ? e[0] : e),
                (this.popper = t && t.jquery ? t[0] : t),
                (this.options.modifiers = {}),
                Object.keys(Ce({}, et.Defaults.modifiers, i.modifiers)).forEach(function (e) {
                    n.options.modifiers[e] = Ce({}, et.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {});
                }),
        ...
        (Ze.Utils = ("undefined" != typeof window ? window : global).PopperUtils), (Ze.placements = Ve), (Ze.Defaults = Je);
        var tt,
            nt = "dropdown",
            it = "bs.dropdown",
            rt = "." + it,
            ...
            mt =
                (((tt = vt.prototype).toggle = function () {
                    if (!this._element.disabled && !p(this._element).hasClass(ct)) {
                        var e = p(this._menu).hasClass(ut);
                        vt._clearMenus(), e || this.show(!0);
                    }
                }),
                (tt.show = function (e) {
                    if ((void 0 === e && (e = !1), !(this._element.disabled || p(this._element).hasClass(ct) || p(this._menu).hasClass(ut)))) {
                        ...
                        if ((p(i).trigger(n), !n.isDefaultPrevented())) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === p(i).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop),
                                ...
                                p(this._menu).toggleClass(ut),
                                p(i).toggleClass(ut).trigger(p.Event(lt.SHOWN, t));
                        }
                    }
                }),
                (tt.hide = function () {
                    if (!this._element.disabled && !p(this._element).hasClass(ct) && p(this._menu).hasClass(ut)) {
                        var e = { relatedTarget: this._element },
                            t = p.Event(lt.HIDE, e),
                            n = vt._getParentFromElement(this._element);
                        p(n).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(ut), p(n).toggleClass(ut).trigger(p.Event(lt.HIDDEN, e)));
                    }
                }),
                (tt.dispose = function () {
                ...
                (tt._getMenuElement = function () {
                    if (!this._menu) {
                        var e = vt._getParentFromElement(this._element);
                ...
                (vt._clearMenus = function (e) {
                    if (!e || (3 !== e.which && ("keyup" !== e.type || 9 === e.which)))
                        for (var t = [].slice.call(document.querySelectorAll(ht)), n = 0, i = t.length; n < i; n++) {
                            var r = vt._getParentFromElement(t[n]),
                                o = p(t[n]).data(it),
                                s = { relatedTarget: t[n] };
                            if ((e && "click" === e.type && (s.clickEvent = e), o)) {
                                var a = o._menu;
                                if (p(r).hasClass(ut) && !(e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && 9 === e.which)) && p.contains(r, e.target))) {
                                    ...
                                    p(r).trigger(l),
                                        l.isDefaultPrevented() ||
                                            ...
                                            p(a).removeClass(ut),
                                            p(r).removeClass(ut).trigger(p.Event(lt.HIDDEN, s)));
                                }
                            }
                        }
                }),
                ...
                (vt._dataApiKeydownHandler = function (e) {
                    if (
                        (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(dt).length))) : at.test(e.which)) &&
                        (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(ct))
                    ) {
                        var t = vt._getParentFromElement(this),
                            n = p(t).hasClass(ut);
                        if (n || 27 !== e.which)
        ...
        p(document)
            ...
            .on(lt.CLICK_DATA_API, ht, function (e) {
        ...
        var yt,
            ...
            Tt = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" },
            Ct = {
                HIDE: "hide" + Et,
                HIDE_PREVENTED: "hidePrevented" + Et,
                HIDDEN: "hidden" + Et,
                SHOW: "show" + Et,
                SHOWN: "shown" + Et,
                FOCUSIN: "focusin" + Et,
            ...
            Nt = ".sticky-top",
            It =
                (((yt = Lt.prototype).toggle = function (e) {
                ...
                (yt.show = function (e) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        var n = p.Event(Ct.SHOW, { relatedTarget: e });
                        p(this._element).trigger(n),
                            this._isShown ||
                                ...
                                p(this._element).on(Ct.CLICK_DISMISS, '[data-dismiss="modal"]', function (e) {
                                    return t.hide(e);
                                }),
                                p(this._dialog).on(Ct.MOUSEDOWN_DISMISS, function () {
                                    p(t._element).one(Ct.MOUSEUP_DISMISS, function (e) {
                ...
                (yt.hide = function (e) {
                    ...
                    if ((e && e.preventDefault(), this._isShown && !this._isTransitioning)) {
                        var n = p.Event(Ct.HIDE);
                        if ((p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())) {
                            this._isShown = !1;
                            var i = p(this._element).hasClass(At);
                            if (
                                (i && (this._isTransitioning = !0),
                                this._setEscapeEvent(),
                                this._setResizeEvent(),
                                p(document).off(Ct.FOCUSIN),
                                p(this._element).removeClass(Ot),
                                p(this._element).off(Ct.CLICK_DISMISS),
                                p(this._dialog).off(Ct.MOUSEDOWN_DISMISS),
                                i)
                            ) {
                ...
                (yt._getConfig = function (e) {
                    return (e = s({}, xt, {}, e)), g.typeCheckConfig(bt, e, Tt), e;
                }),
                (yt._triggerBackdropTransition = function () {
                    var e = this;
                    if ("static" === this._config.backdrop) {
                        var t = p.Event(Ct.HIDE_PREVENTED);
                        if ((p(this._element).trigger(t), t.defaultPrevented)) return;
                        this._element.classList.add(Dt);
                        var n = g.getTransitionDurationFromElement(this._element);
                        p(this._element)
                            .one(g.TRANSITION_END, function () {
                                e._element.classList.remove(Dt);
                            })
                ...
                (yt._showElement = function (e) {
                    ...
                    (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                        ...
                        p(this._element).addClass(Ot),
                        this._config.focus && this._enforceFocus();
                    var o = p.Event(Ct.SHOWN, { relatedTarget: e });
                    if (n) {
                ...
                (yt._setEscapeEvent = function () {
                    ...
                    this._isShown && this._config.keyboard
                        ? p(this._element).on(Ct.KEYDOWN_DISMISS, function (e) {
                              27 === e.which && t._triggerBackdropTransition();
                          })
                        : this._isShown || p(this._element).off(Ct.KEYDOWN_DISMISS);
                }),
                (yt._setResizeEvent = function () {
                    var t = this;
                    this._isShown
                        ? p(window).on(Ct.RESIZE, function (e) {
                              return t.handleUpdate(e);
                          })
                        : p(window).off(Ct.RESIZE);
                }),
                (yt._hideModal = function () {
                    ...
                    (this._element.style.display = "none"),
                        ...
                        (this._isTransitioning = !1),
                        this._showBackdrop(function () {
                            p(document.body).removeClass(St), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(Ct.HIDDEN);
                        });
                }),
                ...
                (yt._showBackdrop = function (e) {
                    var t = this,
                        n = p(this._element).hasClass(At) ? At : "";
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            p(this._element).on(Ct.CLICK_DISMISS, function (e) {
                                t._ignoreBackdropClick ? (t._ignoreBackdropClick = !1) : e.target === e.currentTarget && t._triggerBackdropTransition();
                            }),
                            n && g.reflow(this._backdrop),
                            p(this._backdrop).addClass(Ot),
                            !e)
                        )
                            return;
                        if (!n) return void e();
                        ...
                        if (p(this._element).hasClass(At)) {
                ...
                (Lt._jQueryInterface = function (n, i) {
                    return this.each(function () {
                        ...
                        if ((e || ((e = new Lt(this, t)), p(this).data(_t, e)), "string" == typeof n)) {
                            if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                            e[n](i);
        ...
        p(document).on(Ct.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
            var t,
                n = this,
                i = g.getSelectorFromElement(this);
            i && (t = document.querySelector(i));
            var r = p(t).data(_t) ? "toggle" : s({}, p(t).data(), {}, p(this).data());
            ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault();
            var o = p(t).one(Ct.SHOW, function (e) {
                e.isDefaultPrevented() ||
                    o.one(Ct.HIDDEN, function () {
                        p(n).is(":visible") && n.focus();
                    });
            });
            It._jQueryInterface.call(p(t), r, this);
        }),
            (p.fn[bt] = It._jQueryInterface),
            (p.fn[bt].Constructor = It),
            (p.fn[bt].noConflict = function () {
                return (p.fn[bt] = wt), It._jQueryInterface;
            });
                    ...
                    i = function (e) {
                        ...
                        i.forEach(function (e) {
                            !(function (e, t) {
                                ...
                                if (-1 !== t.indexOf(n)) return -1 === jt.indexOf(n) || Boolean(e.nodeValue.match(Mt) || e.nodeValue.match(Pt));
                                for (
        ...
        var Ht,
            ...
            en = "focus",
            tn =
                (((Ht = nn.prototype).enable = function () {
                    this._isEnabled = !0;
                }),
                (Ht.disable = function () {
                    this._isEnabled = !1;
                ...
                (Ht.addAttachmentClass = function (e) {
                ...
                (Ht.setElementContent = function (e, t) {
                    "object" != typeof t || (!t.nodeType && !t.jquery)
                        ? this.config.html
                            ? (this.config.sanitize && (t = Rt(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
                            : e.text(t)
                        : this.config.html
                ...
                (Ht._getPopperConfig = function (e) {
                    var t = this;
                    return s(
                        {},
                        {
                ...
                (Ht._getConfig = function (e) {
                    ...
                    return (
                        ...
                        e.sanitize && (e.template = Rt(e.template, e.whiteList, e.sanitizeFn)),
                        e
                    );
                }),
                ...
                (Ht._handlePopperPlacementChange = function (e) {
                    var t = e.instance;
                ...
                (nn._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = p(this).data(qt),
                            t = "object" == typeof n && n;
                        if ((e || !/dispose|hide/.test(n)) && (e || ((e = new nn(this, t)), p(this).data(qt, e)), "string" == typeof n)) {
                            if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                            e[n]();
                        }
                    });
        ...
        (p.fn[Wt] = tn._jQueryInterface),
            (p.fn[Wt].Constructor = tn),
            (p.fn[Wt].noConflict = function () {
                return (p.fn[Wt] = Bt), tn._jQueryInterface;
            });
        var rn = "popover",
            on = "bs.popover",
            sn = "." + on,
            ...
            un = s({}, tn.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        ...
        (p.fn[rn] = dn._jQueryInterface),
            (p.fn[rn].Constructor = dn),
            (p.fn[rn].noConflict = function () {
                return (p.fn[rn] = an), dn._jQueryInterface;
            });
        var pn,
            gn = "scrollspy",
            mn = "bs.scrollspy",
            ...
            En = { ACTIVATE: "activate" + vn, SCROLL: "scroll" + vn, LOAD_DATA_API: "load" + vn + ".data-api" },
            wn = "active",
            xn = ".nav, .list-group",
            Tn = ".nav-link",
            Cn = ".list-group-item",
            Sn = "position",
            An =
                (((pn = On.prototype).refresh = function () {
                    var t = this,
                ...
                (pn._getConfig = function (e) {
                    if ("string" != typeof (e = s({}, bn, {}, "object" == typeof e && e ? e : {})).target) {
                        var t = p(e.target).attr("id");
                        t || ((t = g.getUID(gn)), p(e.target).attr("id", t)), (e.target = "#" + t);
                    }
                    return g.typeCheckConfig(gn, e, _n), e;
                }),
                ...
                (pn._activate = function (t) {
                    ...
                    n.hasClass("dropdown-item")
                        ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(wn), n.addClass(wn))
                        : (n.addClass(wn),
                          n
                              .parents(xn)
                              .prev(Tn + ", " + Cn)
                              .addClass(wn),
                          n.parents(xn).prev(".nav-item").children(Tn).addClass(wn)),
                        p(this._scrollElement).trigger(En.ACTIVATE, { relatedTarget: t });
                }),
                (pn._clear = function () {
                    [].slice
                        .call(document.querySelectorAll(this._selector))
                ...
                (On._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        if ((e || ((e = new On(this, "object" == typeof t && t)), p(this).data(mn, e)), "string" == typeof t)) {
                            if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                            e[t]();
                        }
                    });
        ...
        function On(e, t) {
            ...
            (this._element = e),
                ...
                (this._config = this._getConfig(t)),
                (this._selector = this._config.target + " " + Tn + "," + this._config.target + " " + Cn + "," + this._config.target + " .dropdown-item"),
                (this._offsets = []),
                (this._targets = []),
                (this._activeTarget = null),
                (this._scrollHeight = 0),
                p(this._scrollElement).on(En.SCROLL, function (e) {
                    return n._process(e);
                }),
                this.refresh(),
                this._process();
        }
        p(window).on(En.LOAD_DATA_API, function () {
        ...
        var Dn,
            ...
            Pn = "> li > .active",
            Rn =
                (((Dn = Hn.prototype).show = function () {
                    var n = this;
                    if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(jn)) || p(this._element).hasClass("disabled"))) {
                        var e,
                            i,
                            t = p(this._element).closest(".nav, .list-group")[0],
                            r = g.getSelectorFromElement(this._element);
                        if (t) {
                            var o = "UL" === t.nodeName || "OL" === t.nodeName ? Pn : Mn;
                ...
                (Dn._activate = function (e, t, n) {
                    function i() {
                        return r._transitionComplete(e, o, n);
                    }
                    var r = this,
                        o = (!t || ("UL" !== t.nodeName && "OL" !== t.nodeName) ? p(t).children(Mn) : p(t).find(Pn))[0],
                ...
                (Dn._transitionComplete = function (e, t, n) {
                    if (t) {
                        p(t).removeClass(jn);
                        var i = p(t.parentNode).find("> .dropdown-menu .active")[0];
                        i && p(i).removeClass(jn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1);
                    }
                    if (
                        (p(e).addClass(jn),
                ...
                (Hn._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = p(this),
                            t = e.data(kn);
                        if ((t || ((t = new Hn(this)), e.data(kn, t)), "string" == typeof n)) {
        ...
        p(document).on(Ln.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
            e.preventDefault(), Rn._jQueryInterface.call(p(this), "show");
        }),
            (p.fn.tab = Rn._jQueryInterface),
            (p.fn.tab.Constructor = Rn),
            (p.fn.tab.noConflict = function () {
                return (p.fn.tab = In), Rn._jQueryInterface;
            });
        var Wn,
            qn = "toast",
            Fn = "bs.toast",
            ...
            Xn =
                ...
                (Wn.hide = function () {
                    if (this._element.classList.contains($n)) {
                        var e = p.Event(Un.HIDE);
                ...
                (Wn._getConfig = function (e) {
                    return (e = s({}, Qn, {}, p(this._element).data(), {}, "object" == typeof e && e ? e : {})), g.typeCheckConfig(qn, e, this.constructor.DefaultType), e;
                }),
                (Wn._setListeners = function () {
                    var e = this;
                ...
                (Wn._close = function () {
                    function e() {
                        t._element.classList.add("hide"), p(t._element).trigger(Un.HIDDEN);
                    }
                    var t = this;
                ...
                (Kn._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = p(this),
                            t = e.data(Fn);
                        if ((t || ((t = new Kn(this, "object" == typeof n && n)), e.data(Fn, t)), "string" == typeof n)) {
                            if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                            t[n](this);
                        }
                    });
        ...
        (p.fn[qn] = Xn._jQueryInterface),
            (p.fn[qn].Constructor = Xn),
            (p.fn[qn].noConflict = function () {
                return (p.fn[qn] = zn), Xn._jQueryInterface;
            }),
            (e.Alert = h),
            (e.Button = S),
            (e.Carousel = B),
    ...
    (function (e, t) {
            ...
            L = {
                f: _
                    ...
                    : function (e, t) {
                          ...
                          if (c(e, t)) return b(!x.f.call(e, t), e[t]);
                      },
            },
        ...
        function ue(e, t) {
            var n;
            return je(e) && (("function" == typeof (n = e.constructor) && (n === Array || je(n.prototype))) || (v(n) && null === (n = n[He]))) && (n = void 0), new (void 0 === n ? Array : n)(0 === t ? 0 : t);
        }
        function fe(d) {
            var p = 1 == d,
                g = 2 == d,
        ...
        var de = {
                ...
                R("inspectSource", function (e) {
                    ...
                    (e.exports = function (e, t, n, i) {
                        var r = !!i && !!i.unsafe,
                            o = !!i && !!i.enumerable,
                            s = !!i && !!i.noTargetGet;
                        "function" == typeof n && ("string" != typeof t || c(n, "name") || P(n, "name", t), (a(n).source = l.join("string" == typeof t ? t : ""))),
                            e !== y ? (r ? !s && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : P(e, t, n)) : o ? (e[t] = n) : f(t, n);
            ...
            He = ce("species"),
            We = [].push,
            qe = { forEach: fe(0), map: fe(1), filter: fe(2), some: fe(3), every: fe(4), find: fe(5), findIndex: fe(6) },
            Fe = qe.forEach,
            Be = he("forEach")
                ? function (e, t) {
                ...
                : [].forEach;
        oe({ target: "Array", proto: !0, forced: [].forEach != Be }, { forEach: Be });
        var ze = {
            CSSRuleList: 0,
        ...
        var at,
            ...
            mt = !1;
        function vt(e, t, n) {
            e && !c((e = n ? e : e.prototype), xt) && wt(e, xt, { configurable: !0, value: t });
        }
        function yt() {
            return this;
        }
        ...
        function _t(e, t, n, i, r, o, s) {
            ...
            (l = t + " Iterator"), ((a = n).prototype = it(Tt, { next: b(1, i) })), vt(a, l, !1), (ut[l] = yt);
            var u,
                f,
                h,
                d = t + " Iterator",
                p = !1,
                g = e.prototype,
                m = g[Ot] || g["@@iterator"] || (r && g[r]),
                v = (!At && m) || c(r),
                y = ("Array" == t && g.entries) || m;
            if (
                (y && ((u = pt(y.call(new e()))), St !== Object.prototype && u.next && (pt(u) !== St && (Ct ? Ct(u, St) : "function" != typeof u[Ot] && P(u, Ot, bt)), vt(u, d, !0))),
                r == Dt &&
                    m &&
                    m.name !== Dt &&
                    ((p = !0),
                ...
                if (((f = { values: c(Dt), keys: o ? v : c("keys"), entries: c(kt) }), s)) for (h in f) (!At && !p && h in g) || pe(g, h, f[h]);
                else oe({ target: t, proto: !0, forced: At || p }, f);
            return f;
        }
        [].keys && ("next" in (ct = [].keys()) ? (lt = pt(pt(ct))) !== Object.prototype && (at = lt) : (mt = !0)),
            null == at && (at = {}),
            c(at, gt) ||
                P(at, gt, function () {
                    return this;
                ...
                m(function () {
                    ...
                    ? function (e, t) {
                          for (var n = le(e), i = arguments.length, r = 1, o = Ce.f, s = x.f; r < i; )
                              for (var a, l = A(arguments[r++]), c = o ? Ge(l).concat(o(l)) : Ge(l), u = c.length, f = 0; f < u; ) (a = c[f++]), (_ && !s.call(l, a)) || (n[a] = l[a]);
                          return n;
                      }
                    : Mt;
        function Rt(e) {
        ...
        oe({ target: "Object", stat: !0, forced: Object.assign !== Pt }, { assign: Pt });
        ...
        function zt(n) {
            return function (e) {
                var t = String(l(e));
                return 1 & n && (t = t.replace(Vt, "")), 2 & n && (t = t.replace(Yt, "")), t;
            };
        }
            ...
            return function (e, t) {
                ...
                return o < 0 || s <= o
                    ? a
                        ? ""
                        : void 0
                    : (n = r.charCodeAt(o)) < 55296 || 56319 < n || o + 1 === s || (i = r.charCodeAt(o + 1)) < 56320 || 57343 < i
                    ? a
                        ? r.charAt(o)
                        : n
                    : a
        ...
        _t(
            ...
            function () {
                var e,
                    ...
                    n = t.string,
                    i = t.index;
                return i >= n.length ? { value: void 0, done: !0 } : ((e = en(n, i)), (t.index += e.length), { value: e, done: !1 });
            }
        );
        var ln = !m(function () {
            ...
            dn = t(function (e) {
                ...
                (e.exports = function (e, t, n, i, r) {
                    ...
                    if (r) o = e;
                        ...
                        if (void 0 !== s && (ut.Array === s || fn[un] === s)) {
                            for (a = 0, l = ee(e.length); a < l; a++) if ((c = i ? f(T((u = e[a]))[0], u[1]) : f(e[a])) && c instanceof h) return c;
                            return new h(!1);
                        }
                        o = s.call(e);
                    }
                    for (; !(u = o.next()).done; ) if ((c = sn(o, f, u.value, i)) && c instanceof h) return c;
                    return new h(!1);
                }).stop = function (e) {
                    return new h(!0, e);
                };
        ...
        function yn(s, e, t, a, i) {
            ...
            if (
                ...
                (c = t.getConstructor(e, s, a, u)), (cn.REQUIRED = !0);
            else if (Ie(s, !0)) {
                var f = new c(),
                    h = f[u](i ? {} : -0, 1) != f,
                    d = m(function () {
                ...
                p ||
                    (((c = e(function (e, t) {
                        ...
                        var n,
                            i,
                            r,
                            o = ((n = new l()), Ct && "function" == typeof (i = e.constructor) && i !== c && v((r = i.prototype)) && r !== c.prototype && Ct(n, r), n);
                        return null != t && dn(t, o[u], o, a), o;
                    })).prototype = r).constructor = c),
                    (d || g) && (n("delete"), n("has"), a && n("get")),
                    (g || h) && n(u),
                    i && r.clear && delete r.clear;
            }
            return oe({ global: !0, forced: (o[s] = c) != l }, o), vt(c, s), i || t.setStrong(c, s, a), c;
        }
        function bn(e) {
        ...
        var On = {
                getConstructor: function (e, n, i, r) {
                    ...
                    var s = e(function (e, t) {
                            an(e, s, n), wn(e, { type: n, id: Sn++, frozen: void 0 }), null != t && dn(t, e[r], e, i);
                        }),
                        a = xn(n);
                    return (
                        on(s.prototype, {
        ...
        function Jn(e) {
            ...
            if ("symbol" == typeof e || (e && "object" == typeof e && Qn.call(e) == Wn)) return Hn;
            if (Gn(e)) {
            ...
            e = e.replace(qn, "");
            var n = Bn.test(e);
            return n || zn.test(e) ? Un(e.slice(2), n ? 2 : 8) : Fn.test(e) ? Hn : +e;
        }
        function Zn() {
            return li.Date.now();
        }
        function ei(e, t, n) {
            ...
            return (
                Gn(n) && ((i = "leading" in n ? !!n.leading : i), (r = "trailing" in n ? !!n.trailing : r)),
                (function (i, r, e) {
                    var o,
                        s,
                        n,
                    ...
                    return (
                        (r = Jn(r) || 0),
                        Gn(e) && ((f = !!e.leading), (n = (h = "maxWait" in e) ? Xn(Jn(e.maxWait) || 0, r) : n), (t = "trailing" in e ? !!e.trailing : t)),
                        (v.cancel = function () {
        ...
        function di(e) {
            if ("number" == typeof e) return e;
            if ("symbol" == typeof e || (e && "object" == typeof e && "[object Symbol]" == ci.call(e))) return NaN;
            if (hi(e)) {
                var t = "function" == typeof e.valueOf ? e.valueOf() : e;
                e = hi(t) ? t + "" : t;
            }
            ...
            e = e.replace(ti, "");
            var n = ii.test(e);
            return n || ri.test(e) ? oi(e.slice(2), n ? 2 : 8) : ni.test(e) ? NaN : +e;
        }
        function pi(i, r, e) {
            var o,
                s,
            ...
            return (
                (r = di(r) || 0),
                hi(e) && ((f = !!e.leading), (n = (h = "maxWait" in e) ? ui(di(e.maxWait) || 0, r) : n), (t = "trailing" in e ? !!e.trailing : t)),
                (v.cancel = function () {
                    void 0 !== l && clearTimeout(l), (o = c = s = l = void (u = 0));
                }),
                (v.flush = function () {
        ...
        (Pi.prototype.clear = function () {
            ...
            (Hi.prototype.clear = function () {
                this.__data__ = { hash: new Pi(), map: new (ji || Ri)(), string: new Pi() };
            }),
        ...
        function cr(e, t) {
            var n,
                ...
                l =
                    ...
                    Zi(a, { x: n, y: i, width: r, height: o, top: i, right: n + r, bottom: o + i, left: n }),
                    a);
            Zi(this, { target: e, contentRect: l });
        }
        var ur =
        ...
        var dr = new ("undefined" != typeof WeakMap ? WeakMap : $i)();
            ...
            if (!o || !s || ("replace" === n && !Pr) || ("split" === n && !Rr)) {
                var a = /./[r],
                    l = t(r, ""[n], function (e, t, n, i, r) {
                        return t.exec === Nr ? (o && !r ? { done: !0, value: a.call(t, n, i) } : { done: !0, value: e.call(n, t, i) }) : { done: !1 };
                    }),
                    c = l[0],
                    u = l[1];
            ...
            function l(e, t) {
                ...
                (this.onScroll = function () {
                    ...
                    (this.onPointerEvent = function (e) {
                        ...
                        (a.axis.x.track.rect = a.axis.x.track.el.getBoundingClientRect()),
                            ...
                            (t || n) &&
                                ...
                                e.stopPropagation(),
                                "mousedown" === e.type &&
                                    (t && ((a.axis.x.scrollbar.rect = a.axis.x.scrollbar.el.getBoundingClientRect()), a.isWithinBounds(a.axis.x.scrollbar.rect) ? a.onDragStart(e, "x") : a.onTrackClick(e, "x")),
                                    n && ((a.axis.y.scrollbar.rect = a.axis.y.scrollbar.el.getBoundingClientRect()), a.isWithinBounds(a.axis.y.scrollbar.rect) ? a.onDragStart(e, "y") : a.onTrackClick(e, "y"))));
                    }),
                    (this.drag = function (e) {
                        ...
                        "x" === a.draggedAxis && ((s = a.isRtl && l.getRtlHelpers().isRtlScrollbarInverted ? s - (n + i.size) : s), (s = a.isRtl && l.getRtlHelpers().isRtlScrollingInverted ? -s : s)),
                    ...
                    l.instances.has(this.el) ||
                        ...
                        (this.hideScrollbars = pi(this.hideScrollbars.bind(this), this.options.timeout)),
                        (this.onWindowResize = pi(this.onWindowResize.bind(this), 64, { leading: !0 })),
                ...
                (e.onTrackClick = function (e, i) {
                    ...
                    if ((void 0 === i && (i = "y"), this.options.clickOnTrack)) {
                        ...
                        !(function e() {
                            var t, n;
                            -1 == a
                                ? l < s && ((s -= 40), r.contentWrapperEl.scrollTo((((t = {})[r.axis[i].offsetAttr] = s), t)), o.requestAnimationFrame(e))
                                : s < l && ((s += 40), r.contentWrapperEl.scrollTo((((n = {})[r.axis[i].offsetAttr] = s), n)), o.requestAnimationFrame(e));
                        })();
                    }
                }),
        ...
        return (
            ...
            (Yr.initHtmlApi = function () {
                (this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this)),
                    "undefined" != typeof MutationObserver && ((this.globalObserver = new MutationObserver(Yr.handleMutations)), this.globalObserver.observe(document, { childList: !0, subtree: !0 })),
    ...
    (function (e) {
        ...
        function r(e, t) {
            var n,
                ...
                l = 0;
            return (
                "wheel" === e.type ? ((n = t.height() / c(window).height()), (l = e.originalEvent.deltaY * n)) : this.options.touch && "touchmove" === e.type && (a = e.originalEvent.changedTouches[0].clientY - this.startClientY),
                { prevent: (i = 0 < a && r + l <= 0) || (a < 0 && o - s <= r + l), top: i, scrollTop: r, deltaY: l }
            );
        }
        function o(e, t) {
            var n,
                ...
                o = { top: !1, bottom: !1 };
            return (
                (o.top = 0 === r && (e.keyCode === a || e.keyCode === f || e.keyCode === h)),
                o.top || ((n = t.prop("scrollHeight")), (i = t.prop("clientHeight")), (o.bottom = n === r + i && (e.keyCode === s || e.keyCode === l || e.keyCode === u || e.keyCode === d))),
                o
            );
        }
        var e,
            ...
            p = function (e, t) {
                (this.$element = e),
                    ...
                    this.options.touch &&
                        (this.$element.on("touchstart" + p.NAMESPACE, this.options.selector, c.proxy(p.CORE.touchHandler, this)),
            ...
            (p.CORE = {
                ...
                keyboardHandler: function (e) {
                    var t,
                        ...
                        i = (n.scrollTop(), o(e, n));
                    return (
                        e.__currentTarget && ((t = o(e, c(e.__currentTarget))), (i.top &= t.top), (i.bottom &= t.bottom)),
                        i.top
                            ? (n.trigger(c.Event("top" + p.NAMESPACE)), this.options.animation && setTimeout(p.CORE.animationHandler.bind(this, n, "top"), 0), !1)
                            : i.bottom
                            ? (n.trigger(c.Event("bottom" + p.NAMESPACE)), this.options.animation && setTimeout(p.CORE.animationHandler.bind(this, n, "bottom"), 0), !1)
                            : void 0
                    );
                },
            }),
