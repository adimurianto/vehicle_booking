...
app.plugins.createPopup({
  container: '.popup-menu-access',
  trigger: '.popup-menu-access-trigger',
  overlay: {
    color: '21, 21, 31',
    opacity: .96
  },
...
app.plugins.createPopup({
  container: '.popup-crud',
  trigger: '.popup-crud-trigger',
  overlay: {
    color: '21, 21, 31',
    opacity: .96
  },
...
app.plugins.createPopup({
  container: '.popup-article',
  trigger: '.popup-article-trigger',
  overlay: {
    color: '21, 21, 31',
    opacity: .96
  },
...
app.plugins.createPopup({
  container: '.popup-update-account',
  trigger: '.popup-update-account-trigger',
  overlay: {
    color: '21, 21, 31',
    opacity: .96
  },
...
app.plugins.createPopup({
  ...
  trigger: '.popup-attribute-trigger',
  overlay: {
    color: '21, 21, 31',
    opacity: .96
  },
