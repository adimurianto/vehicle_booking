<main id="main-container">
  ...
  <!-- Popup -->  
  <div class="modal fade" id="modal-menu-access" tabindex="-1" role="dialog" aria-labelledby="modal-large" aria-modal="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="block block-themed block-transparent mb-0">
          <div class="block-header bg-primary-dark">
            <h3 class="block-title popup-menu-title">+ Atur Akses Menu</h3>
            <div class="block-options">
              <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                <i class="si si-close"></i>
              </button>
          ...
          <!-- FORM -->
          <form class="form" id="form-menu" method="POST">
            <div class="block-content">
              <input type="hidden" name="authority" value="">
              <input type="hidden" name="authority_name" value="">
              <div class="row">
                <div class="col-md-12" id="menu-access"></div>
              </div>
            </div>
            
            <div class="modal-footer">
                <button type="button" class="btn btn-alt-secondary" data-dismiss="modal">Close</button>
                <button class="btn btn-alt-success" id="btn-save-menu">
                    <i class="fa fa-check"></i> Simpan
                </button>
            </div>

            <div class="loader-wrapper" id="crud-loader-menu">
              <div class="loader-bars">
                <div class="loader-bar"></div>
                <div class="loader-bar"></div>
                <div class="loader-bar"></div>
